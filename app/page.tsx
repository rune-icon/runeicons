...
const Page = () => {
  return (
    <div className="relative w-full grid min-h-screen grid-cols-[1fr_auto_1fr] grid-rows-[auto_1px_auto_1px_auto_1px_auto_1px_auto_1px_auto_1px_auto] bg-[#F5F5F5] dark:bg-background font-[family-name:var(--font-inter-tight)] overflow-hidden">
      {/* Row 1: Navbar */}
      <div className="col-start-2 row-start-1 flex w-[90vw] px-3 sm:px-6 py-3 flex-col relative overflow-hidden">
        <Navbar />
      </div>
      ...
      {/* Row 2: Hero Section */}
      <div className="col-start-2 row-start-3 flex flex-col w-[90vw] px-6 gap-2">
        <HeroSection />
      </div>
      ...
      <div className="col-start-2 row-start-5 flex flex-col w-[90vw] px-6 gap-2">
        <Search />
      </div>
      ...
      {/* Row 4: Bento Section */}
      <div className="col-start-2 row-start-7 flex flex-col w-[90vw] px-6">
        <Bento />
      </div>
      ...
      <div className="col-start-2 row-start-9 flex flex-col w-[90vw] px-6">
        <Testimonials />
      </div>
      ...
      {/* Row 6: FAQ Section */}
      <div className="col-start-2 row-start-11 flex flex-col w-[90vw] px-6">
        <Faq />
      </div>
      ...
      {/* Row 7: Footer */}
      <div className="col-start-2 row-start-13 flex flex-col w-[90vw] px-6 py-6">
        <Footer />
      </div>
